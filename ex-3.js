...
// Start coding here
let totalAmountOfOrderOfBirdieShepland = 0;

for (let i = 0; i < orders.length; i++) {
  if (orders[i].customerName === "Birdie Shepland") {
    totalAmountOfOrderOfBirdieShepland =
      totalAmountOfOrderOfBirdieShepland +
      orders[i].productPrice * orders[i].productQuantity;
  }
}
console.log(
  `Total paid amount of Birdie Shepland: ${totalAmountOfOrderOfBirdieShepland} Baht`
);
